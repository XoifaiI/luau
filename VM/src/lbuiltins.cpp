...
const luau_FastFunction luauF_table[256] = {
    ...
    luauF_missing, // LBF_SIMD_FADD
    luauF_missing, // LBF_SIMD_FSUB
    luauF_missing, // LBF_SIMD_FMUL
    luauF_missing, // LBF_SIMD_FDIV
    luauF_missing, // LBF_SIMD_FMIN
    luauF_missing, // LBF_SIMD_FMAX
    luauF_missing, // LBF_SIMD_FSQRT
    luauF_missing, // LBF_SIMD_FMA
    luauF_missing, // LBF_SIMD_TOFLOAT
    luauF_missing, // LBF_SIMD_TOINT
    luauF_missing, // LBF_SIMD_SHUFFLE
    luauF_missing, // LBF_BUFFER_READSIMD256
    ...
    luauF_missing, // LBF_SIMD256_BNOT
    luauF_missing, // LBF_SIMD256_SHL
    luauF_missing, // LBF_SIMD256_SHR
    luauF_missing, // LBF_SIMD256_ROTL
    luauF_missing, // LBF_SIMD256_SHUFFLE
    luauF_missing, // LBF_SIMD256_FADD
    luauF_missing, // LBF_SIMD256_FSUB
    luauF_missing, // LBF_SIMD256_FMUL
    luauF_missing, // LBF_SIMD256_FDIV
    luauF_missing, // LBF_SIMD256_FMIN
    luauF_missing, // LBF_SIMD256_FMAX
    luauF_missing, // LBF_SIMD256_FSQRT
    ...
    luauF_missing, // LBF_SIMD_SUM
    luauF_missing, // LBF_SIMD_HMIN
    luauF_missing, // LBF_SIMD_HMAX
    luauF_missing, // LBF_SIMD_HBAND
    luauF_missing, // LBF_SIMD_HBOR
    luauF_missing, // LBF_SIMD_HBXOR
    luauF_missing, // LBF_SIMD256_SUM
    luauF_missing, // LBF_SIMD256_HMIN
    luauF_missing, // LBF_SIMD256_HMAX
    luauF_missing, // LBF_SIMD256_HBAND
    luauF_missing, // LBF_SIMD256_HBOR
    luauF_missing, // LBF_SIMD256_HBXOR
